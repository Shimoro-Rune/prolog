...
presentation:-write('  _  _                _             _    _   _           _            \n'),
              ...
              write('======================================================================\n'),
              write('           Добро пожаловать в Акинатор по вселенной Наруто!\n'),
...
%Akatsuki
lineAkatsuki(L,X,DataIn,DataOut):- write('Является/Являлся ли Ваш персонаж участником Акацуки? (y/n/Idk)\n'),
        read(Akatsuki),
        list('akatsuki',C),
